...
-(void)drawRect:(CGRect)rect{
    ...
    UIImage *videoIcon = [UIImage imageNamed:@"AssetsPickerVideo@2x.png"];
...
+ (void)initialize
{
    checkedIcon = [UIImage imageNamed:@"gou"];
    checkedNoIcon = [UIImage imageNamed:@"No"];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row==ceil(self.assets.count*1.0/columns)) {
        ...
        if (_numberOfVideos == 0)
            title = [NSString stringWithFormat:@"相片%ld张", (long)_numberOfPhotos];
        else if (_numberOfPhotos == 0)
            title = [NSString stringWithFormat:@"视频%ld个", (long)_numberOfVideos];
        else
            title = [NSString stringWithFormat:@"相片%ld张,视频%ld个", (long)_numberOfPhotos, (long)_numberOfVideos];
...
//    [picker.navigationBar setBarTintColor:APPMainColor];
...
-(void)addView
{
    ...
    UIView *view12  =[[UIView alloc] initWithFrame:self.view.bounds];
    view12.backgroundColor =[UIColor blackColor];
    view12.alpha = 0.8;
    [self.view addSubview:view12];
   _activityIndicator = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 45.0f, 45.0f)];
    _activityIndicator.hidesWhenStopped = YES;
    _activityIndicator.centerX = self.view.width * 0.5;
    _activityIndicator.centerY = self.view.height * 0.5;
    [_activityIndicator setActivityIndicatorViewStyle:UIActivityIndicatorViewStyleGray];
    [view12 addSubview:_activityIndicator];
